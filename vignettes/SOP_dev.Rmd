...
The functionality in this package is most easily accessed using the interactive Shiny Dashboard, which is outlined in this [vignette](SOP.html). This vignette focuses on how to use the R functions included in this package for more flexible predictions.
...
parameters, see "Model Configuration" section [LINK]). 
