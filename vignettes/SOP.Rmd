...
added to any table. The function `SBCpip::process_data_for_date` serves as a 
...
the data files provided. They can then build the database using these settings [Step 2 in **How to use this package** above].
...
They are plotted against `l1_bound`, which is the constraint on the absolute value of the sum
